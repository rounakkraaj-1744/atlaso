...
export function checkLatencyViolation( path: string[], latencies: number[], slaLatencyMs: number ): LatencyViolation | null {
...
export function latencyBudgetPerHop( slaLatencyMs: number, hopCount: number, reservedPercent = 20 ): number {
...
export function exceedsLatencyBudget( nodeLatency: number, budgetMs: number ): boolean {

...
export function checkThroughputViolation( nodeId: string, currentCapacity: number, avgLoad: number, peakLoad: number ): ThroughputViolation | null {
...
export function requiredScalingFactor( baseThroughput: number, targetThroughput: number, headroomPercent = 20, ): number {

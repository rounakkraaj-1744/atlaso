  ...
  return createPortal(
    <>
      ...
      <motion.div
        ...
        className="fixed right-0 top-0 h-full w-80 bg-slate-900/95 backdrop-blur-2xl border-l border-white/10 shadow-2xl z-[100] flex flex-col"
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-black/20 border border-white/10 rounded-lg text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-black/20 border border-white/10 rounded-lg text-slate-200 font-mono focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all"
            />
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-3 py-2 bg-black/20 border border-white/10 rounded-lg text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all appearance-none"
              >
        ...
        <div className="px-6 py-4 border-t border-white/5 flex gap-3">
          <button
            onClick={onClose}
            className="flex-1 px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-slate-300 hover:bg-white/10 transition-colors"
          >
            Cancel
          </button>
          <button
            onClick={handleSave}
            className="flex-1 px-4 py-2 bg-blue-600 rounded-lg text-white hover:bg-blue-500 transition-colors shadow-lg shadow-blue-500/20"
          >
            Save Changes
          </button>
        </div>

...
import { ProviderMappingModal, ReplaceTechnologyModal } from './components/modals/ProviderMappingModal';
    ...
    <DndProvider backend={backend} options={backendOptions}>
      <div className="h-screen flex flex-col bg-transparent">
        ...
        <TopNavigation
          ...
          projectName="WhatsApp Clone v2"
          onOpenProviderMapping={() => setShowProviderMappingModal(true)}
        />
            ...
            {(isLeftPanelOpen || window.innerWidth >= 768) && (
              ...
              >
                <div className="h-full flex flex-col relative">
                  <button
                    className="md:hidden absolute top-2 right-2 p-2 text-slate-400 hover:text-white z-10"
              ...
              <AnimatePresence mode="wait">
                {(isRightPanelOpen || window.innerWidth >= 768) && (
                  <motion.div
                    ...
                    transition={{ type: 'spring', damping: 25, stiffness: 200 }}
                    className={`
                      fixed inset-y-0 right-0 z-30 w-[340px] bg-[#09090b]/95 border-l border-white/5 pt-14 md:pt-0
                      md:relative md:translate-x-0 md:inset-auto md:w-[340px]
      ...
      <ProviderMappingModal isOpen={showProviderMappingModal} onClose={() => setShowProviderMappingModal(false)} />
